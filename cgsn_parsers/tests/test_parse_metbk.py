...
class TestParsingUnit(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected = np.array([
            ...
            [1020.12, np.nan, np.nan, 343.5, 14.03, 9.115, 3.0978, 17.5,  -3.23,   4.32],
            [1020.94, np.nan, np.nan, 341.6, 14.01, 9.131, 3.0997, 16.9,  -5.14,   4.22],
            [1020.94, np.nan, np.nan, 338.6, 13.97, 9.132, 3.0997, 15.3,  -4.57,   4.06]])
